...
public class SchedulerFolderView extends BaseFolderView {
    private static final String menuHeading = "Scheduler";

    private final Folder cronJob = new Folder("Cronjob");

    public SchedulerFolderView(Controller controller) { 
        super(controller);
    }
    ...
    protected void initUI() {
        ...
        navEntry.addListener(Events.Expand, 
            ...
            public void handleEvent(ComponentEvent e) {
                Dispatcher.get().dispatch(AppEvents.NAV_CRONJOB);
            }
        });
        ...
        tree.getSelectionModel().addSelectionChangedListener(
            ...
            public void selectionChanged(SelectionChangedEvent<Folder> se) {
                ...
                if ( f.equals(cronJob.getName()) ) {

                    evt = new AppEvent(AppEvents.NAV_CRONJOB);
